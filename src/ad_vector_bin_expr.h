#ifndef __AD_VECTOR_BIN_EXPR_H_
#define __AD_VECTOR_BIN_EXPR_H_

template <typename LExpr,typename BinOp,typename RExpr>
class ad_vector_bin_expr{
   public:

      ad_vector_bin_expr(LExpr l, RExpr r) : 
         _lhs(std::forward<LExpr>(l)), 
         _rhs(std::forward<RExpr>(r)){}

      //shut down default ctor...
      ad_vector_bin_expr() = delete;
      //...and no copies...
      ad_vector_bin_expr(ad_vector_bin_expr const&) = delete;
      ad_vector_bin_expr& operator =(ad_vector_bin_expr const&) = delete;

      // Moves are ok.
      ad_vector_bin_expr(ad_vector_bin_expr&&) = default;
      ad_vector_bin_expr& operator =(ad_vector_bin_expr&&) = default;
...
class ad_vector_bin_expr<double&&, BinOp,RExpr>{
   public:

      ad_vector_bin_expr(double l, RExpr r) : 
...
class ad_vector_bin_expr<LExpr,BinOp,double&&>{
   public:

      ad_vector_bin_expr(LExpr l, double r) : 
         _lhs(std::forward<LExpr>(l)), 
